      ...
      <div id="share" className="welcome">
        <div className="share-content-wrapper">
          <>
            ...
            <p>Send to your friends, save for yourself, or post it on <a href="https://www.facebook.com/Banana-Drum-108081858593069" target="_blank" rel="noreferrer">Banana Drum's Facebook page</a>!</p>
          </>
        </div>
        <button
          id="load-button"
